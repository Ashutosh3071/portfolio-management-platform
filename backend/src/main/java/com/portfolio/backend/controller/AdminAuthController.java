...
public class AdminAuthController {
    ...
    public AdminAuthController(AdminUserRepository repo, JwtUtil jwtUtil) {
        this.repo = repo;
        this.jwtUtil = jwtUtil;
    }

    @PostMapping("/login")
    public Map<String, String> login(@RequestBody AdminUser req) {
        AdminUser admin = repo.findByUsername(req.getUsername())
